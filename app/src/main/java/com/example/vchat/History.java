...
public class History extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        paint = (DrawView) view.findViewById(R.id.draw_view);
//        rangeSlider = (RangeSlider) view.findViewById(R.id.rangebar);
        ...
        dnc = (Button)view.findViewById(R.id.decrement);
        distrokeval = (EditText)view.findViewById(R.id.strokesize);
        strokeval = (ImageButton)view.findViewById(R.id.setvalue);

        distrokeval.setText(""+value);
